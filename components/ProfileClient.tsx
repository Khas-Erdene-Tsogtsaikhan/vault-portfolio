...
import { currency, getItemReturn, getNextTierProgress, getPortfolioMetrics, percent } from "@/lib/portfolio-utils";
        ...
        <div className="vault-panel rounded-lg p-5">
          ...
          <div className="mt-5 grid gap-4 bg-vault-black p-5 sm:grid-cols-[1fr_1fr]">
            ...
            <div className="grid grid-cols-2 gap-2">
              {items.slice(0, 4).map((item) => <div key={item.id} className="relative aspect-square overflow-hidden rounded-md border border-vault-border"><Image src={item.photos[0]?.url} alt="" fill sizes="130px" className="object-cover" /></div>)}
            </div>
          </div>
